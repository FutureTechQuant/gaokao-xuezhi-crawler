...
def crawl_university_detail(context, row, save_html=None, file_name=None):
    ...
    try:
        ...
        return {
            ...
            'name': row.get('name') or row.get('school_name') or '',
            'item_id': row.get('item_id') or row.get('university_id') or '',
